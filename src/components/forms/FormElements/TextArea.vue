<template>
  <div class="space-y-6">
    ...
    <div>
      ...
      <textarea v-model="normalDescription" placeholder="Enter a description..." rows="6"
    ...
    <div>
      ...
      <textarea v-model="disabledDescription" placeholder="Enter a description..." rows="6" disabled
    ...
    <div>
      ...
      <textarea v-model="errorDescription" placeholder="Enter a description..." rows="6"
