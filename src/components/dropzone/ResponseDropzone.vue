        ...
        <form ref="dropzoneForm" :id="dropzoneId" :action="uploadUrl"
            ...
            <div class="dz-message m-0!">
                <div class="mb-[22px] flex justify-center">
                    <div
                        class="flex h-[30px] w-[30px] items-center justify-center rounded-full bg-gray-200 text-gray-700 dark:bg-gray-800 dark:text-gray-400">
...
const emit = defineEmits(['afterUpload', 'uploadComplete'])
