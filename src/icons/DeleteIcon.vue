<template>
    <svg viewBox="0 0 1024 1024" title="Supprimer" class="icon" version="1.1"
                            ...
                            <g id="SVGRepo_bgCarrier" stroke-width="0"
                                data-v-inspector="src/components/survey/ActionPanel.vue:24:17"></g>
                            <g id="SVGRepo_tracerCarrier" stroke-linecap="round" stroke-linejoin="round"
                                data-v-inspector="src/components/survey/ActionPanel.vue:25:17"></g>
                            <g id="SVGRepo_iconCarrier" data-v-inspector="src/components/survey/ActionPanel.vue:26:17">
                                <path
                                    d="M667.8 362.1H304V830c0 28.2 23 51 51.3 51h312.4c28.4 0 51.4-22.8 51.4-51V362.2h-51.3z"
                                    fill="#ffffff" data-v-inspector="src/components/survey/ActionPanel.vue:27:21">
                                </path>
                                <path
                                    ...
                                    fill="#ffffff" data-v-inspector="src/components/survey/ActionPanel.vue:29:21">
                                </path>
                                <path
                                    ...
                                    fill="#ff2949" data-v-inspector="src/components/survey/ActionPanel.vue:32:21">
                                </path>
                                <path
                                    ...
                                    fill="#ff2949" data-v-inspector="src/components/survey/ActionPanel.vue:35:21">
                                </path>
                            </g>
                        </svg>
</template>